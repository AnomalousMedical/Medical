...
LicenseFile=S:\Medical\Doppler\Doppler_EULA.rtf
OutputDir=S:\Medical\PublicRelease\Setups
OutputBaseFilename=DopplerDiagnosisSetup
Compression=lzma
...
[Files]
Source: "S:\Medical\PublicRelease\Doppler.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "S:\Medical\PublicRelease\Doppler.dat"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "S:\Medical\PublicRelease\Doc\DopplerDiagnosisManual.htb"; DestDir: "{app}\Doc"; Flags: ignoreversion
;Dependencies
