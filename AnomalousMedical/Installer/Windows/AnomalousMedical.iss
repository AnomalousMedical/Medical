...
SignTool=AnomalousMedicalSign /d $qAnomalous Medical Installer$q /t http://timestamp.comodoca.com/authenticode $f
...
Source: S:\Medical\PublicRelease\Mono.Security.dll; DestDir: {app}; Flags: ignoreversion
