...
namespace Medical
{
    class TRmlEditorContext
    {
        ...
        public TRmlEditorContext(String file, String rmlPreviewFile, TRmlTypeController trmlTypeController)
        {
            ...
            TextEditorView textEditorView = new TextEditorView("RmlEditor", () => this.trmlTypeController.loadText(currentFile), wordWrap: false, textHighlighter:RmlTextHighlighter.Instance);
        ...
        {
            trmlTypeController.updateCachedText(currentFile, CurrentText);
