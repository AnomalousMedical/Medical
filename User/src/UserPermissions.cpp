...
:handle(HASP_INVALID_HANDLE_VALUE)
{
	...
	switch(simVersion)
	{
		...
		case SimulatedVersion::DentitionAndProfile:
		...
		case SimulatedVersion::Clinical:
			allowedFeatures.AddLast(Features::PIPER_JBO_MODULE);
		...
		case SimulatedVersion::Radiography:
			allowedFeatures.AddLast(Features::PIPER_JBO_MODULE);
		...
		case SimulatedVersion::Graphics:
			allowedFeatures.AddLast(Features::PIPER_JBO_MODULE);
