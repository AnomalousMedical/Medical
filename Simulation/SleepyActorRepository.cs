...
namespace Medical
{
    ...
    /// </summary>
    static class SleepyActorRepository
    {
        ...
        public static void addSleeper(RigidBody sleeper)
        {
        ...
        /// </summary>
        /// <param name="sleeper"></param>
        public static void removeSleeper(RigidBody sleeper)
        {
