...
namespace Medical
{
    public partial class AnatomyIdentifier : BehaviorInterface, Anatomy
    {
        ...
        //commented ones are kept
        public static readonly String[] alwaysRemoveTags = {
                                        //"Jaw",
                                        "Zygomatic Bone",
                                        "Trachea",
                                        //"Thoracic Vertebrae",
        ...
        protected override void customLoad(LoadInfo info)
        {
            ...
            if (info.Version < 1)
            {
                ...
                tags.AddRange(anatomyTags.Where(i => !(toRemove.Contains(i) || alwaysRemoveTags.Contains(i.Tag))).Select(t => t.Tag));
            }
            else
            {
