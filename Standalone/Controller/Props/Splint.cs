...
namespace Medical
{
    class Splint : Interface
    {
        ...
        public static void createPropDefinition(PropFactory propFactory)
        {
            ...
            //-------Mandibular------
            //MandibularFullCoverage
            splitDefinition = createSplitDefinition("MandibularFullCoverage", "MandibularFullCoverage.mesh", "MandibularFullCoverageCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(-2.14577E-06f, -10.1296f, 8.09898f), new Quaternion(1.490118E-08f, -4.511825E-08f, 6.723153E-16f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //BoChin4Skin
            splitDefinition = createSplitDefinition("BoChin4Skin", "BoChin4Skin.mesh", "BoChin4SkinCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(-4.74276E-07f, -12.5463f, 10.8493f), new Quaternion(-4.56956E-08f, 3.975241E-08f, -3.97524E-08f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibleGums
            splitDefinition = createSplitDefinition("MandibleGums", "MandibleGums.mesh", "MandibleGumsCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(-1.66893E-06f, -11.1689f, 7.81636f), new Quaternion(7.89747E-15f, -1.986665E-07f, -3.97524E-08f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //BoneVeinsArteriesMove
            splitDefinition = createSplitDefinition("BoneVeinsArteriesMove", "BoneVeinsArteriesMove.mesh", "BoneVeinsArteriesMoveCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(1.07722E-06f, -11.6201f, 6.01497f), new Quaternion(7.35137E-08f, 3.975241E-08f, 7.94569E-08f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //RightSubmandibularSublingualGland
            splitDefinition = createSplitDefinition("RightSubmandibularSublingualGland", "RightSubmandibularSublingualGland.mesh", "RightSubmandibularSublingualGlandCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(-2.19789f, -12.4169f, 6.83261f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //LeftSubmandibularSublingualGland
            splitDefinition = createSplitDefinition("LeftSubmandibularSublingualGland", "LeftSubmandibularSublingualGland.mesh", "LeftSubmandibularSublingualGlandCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(2.19789f, -12.4169f, 6.83261f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibularFullCoverageDualFlatPlane
            splitDefinition = createSplitDefinition("MandibularFullCoverageDualFlatPlane", "MandibularFullCoverageDualFlatPlane.mesh", "MandibularFullCoverageDualFlatPlaneCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.2264f, 8.31641f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibularFullCoverageDualBall
            splitDefinition = createSplitDefinition("MandibularFullCoverageDualBall", "MandibularFullCoverageDualBall.mesh", "MandibularFullCoverageDualBallCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.1498f, 8.11417f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibularFullCoverageDualBallTripod
            splitDefinition = createSplitDefinition("MandibularFullCoverageDualBallTripod", "MandibularFullCoverageDualBallTripod.mesh", "MandibularFullCoverageDualBallTripodCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.1498f, 8.11417f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibularFullCoverageDualBallColission
            splitDefinition = createSplitDefinition("MandibularFullCoverageDualBallColission", "MandibularFullCoverageDualBallColission.mesh", "MandibularFullCoverageDualBallColissionCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.1498f, 8.11417f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibularFullCoverageDualBallCollision
            splitDefinition = createSplitDefinition("MandibularFullCoverageDualBallCollision", "MandibularFullCoverageDualBallCollision.mesh", "MandibularFullCoverageDualBallCollisionCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.1498f, 8.11417f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MandibularFullCoverageDualFlatPlaneCollision
            splitDefinition = createSplitDefinition("MandibularFullCoverageDualFlatPlaneCollision", "MandibularFullCoverageDualFlatPlaneCollision.mesh", "MandibularFullCoverageDualFlatPlaneCollisionCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.2264f, 8.31641f), new Quaternion(2.980228E-08f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);
            ...
            //MandibularFullCoverageFlatPlane
            splitDefinition = createSplitDefinition("MandibularFullCoverageFlatPlane", "MandibularFullCoverageFlatPlane.mesh", "MandibularFullCoverageFlatPlaneCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.1154f, 8.15084f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MaxillaryFullCoverageFlatPlane
            splitDefinition = createSplitDefinition("MaxillaryFullCoverageFlatPlane", "MaxillaryFullCoverageFlatPlane.mesh", "MaxillaryFullCoverageFlatPlaneCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(-2.3913E-07f, -9.86613f, 8.14113f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MaxillaryFullCoverage
            splitDefinition = createSplitDefinition("MaxillaryFullCoverage", "MaxillaryFullCoverage.mesh", "MaxillaryFullCoverageCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -9.65886f, 8.20467f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MaxillaryFullCoverageDualShelf
            splitDefinition = createSplitDefinition("MaxillaryFullCoverageDualShelf", "MaxillaryFullCoverageDualShelf.mesh", "MaxillaryFullCoverageDualShelfCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -9.70508f, 8.18003f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //NTI
            splitDefinition = createSplitDefinition("NTI", "NTI.mesh", "NTICollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -9.85379f, 10.9718f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MaxillaryFullCoverageDualShelfTripod
            splitDefinition = createSplitDefinition("MaxillaryFullCoverageDualShelfTripod", "MaxillaryFullCoverageDualShelfTripod.mesh", "MaxillaryFullCoverageDualShelfTripodCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -9.70508f, 8.18003f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //AnteriorDeprogrammer
            splitDefinition = createSplitDefinition("AnteriorDeprogrammer", "AnteriorDeprogrammer.mesh", "AnteriorDeprogrammerCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -10.0156f, 9.91062f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MaxillaryFullCoverageEquilibrated
            splitDefinition = createSplitDefinition("MaxillaryFullCoverageEquilibrated", "MaxillaryFullCoverageEquilibrated.mesh", "MaxillaryFullCoverageEquilibratedCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(0f, -9.80841f, 8.19537f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);

            //MaxillaryFullCoverageDualFlatPlane
            splitDefinition = createSplitDefinition("MaxillaryFullCoverageDualFlatPlane", "MaxillaryFullCoverageDualFlatPlane.mesh", "MaxillaryFullCoverageDualFlatPlaneCollision", BOTTOM_TEETH_SPLINT_FILTER, 1.0f, new Vector3(2.37629E-07f, -9.69486f, 8.11088f), new Quaternion(0f, 0f, 0f, 1f));
            jointToMandible(splitDefinition);
            propFactory.addDefinition(splitDefinition.Name, splitDefinition);
