...
namespace Medical
{
    ...
    class NavigationOverlay : IDisposable, UpdateListener
    {
        ...
        public NavigationOverlay(String name, SceneViewWindow window, NavigationController navigationController)
        {
            loadResources();
            this.name = name;
        ...
        {
            window.setPosition(source.Link.Destination.Translation, source.Link.Destination.LookAt);
        ...
        void window_FindVisibleObjects(SceneViewWindow window, bool callingCameraRender)
        {
