...
{
    public class DecimalNotEqualTest : TestAction
    {
        public DecimalNotEqualTest(AnalysisAction successAction, AnalysisAction failureAction)
            : base(successAction, failureAction)
        {

        }

        public DecimalNotEqualTest(AnalysisAction successAction, AnalysisAction failureAction, decimal testValue, DataRetriever data, decimal defaultValue)
        ...
        protected DecimalNotEqualTest(LoadInfo info)
            : base(info)
        {
