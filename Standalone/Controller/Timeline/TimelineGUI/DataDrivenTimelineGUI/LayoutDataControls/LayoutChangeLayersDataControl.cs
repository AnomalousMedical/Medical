...
{
    class LayoutChangeLayersDataControl : LayoutWidgetDataControl
    {
        private Button button;
        private ChangeLayersDataField dataField;
        private DataDrivenTimelineGUI gui;

        public LayoutChangeLayersDataControl(Button button, DataDrivenTimelineGUI gui, ChangeLayersDataField dataField)
        {
            this.button = button;
