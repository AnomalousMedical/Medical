...
namespace Medical
{
    class MoveCameraChangeLayersDataControl : DataControl
    {
        private Button button;
        private MoveCameraChangeLayersDataField dataField;
        private DataDrivenTimelineGUI gui;

        public MoveCameraChangeLayersDataControl(Widget parentWidget, DataDrivenTimelineGUI gui, MoveCameraChangeLayersDataField dataField)
        {
