...
namespace Medical
{
    class CloseGUIPlayTimelineDataControl : DataControl
    {
        private Button button;
        private CloseGUIPlayTimelineField field;
        private DataDrivenTimelineGUI gui;

        public CloseGUIPlayTimelineDataControl(Widget parentWidget, DataDrivenTimelineGUI gui, CloseGUIPlayTimelineField field)
        {
