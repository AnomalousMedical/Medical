...
namespace Standalone
{
    ...
    class StandaloneController : IDisposable
    {
        ...
        public void go()
        {
            ...
            SceneViewWindow camera3 = sceneViewController.createWindow("Camera 3", new Vector3(-170, -5, 0), new Vector3(0, -5, 0), camera2, WindowAlignment.Bottom);
            SceneViewWindow camera4 = sceneViewController.createWindow("Camera 4", new Vector3(170, -5, 0), new Vector3(0, -5, 0), camera3, WindowAlignment.Left);
